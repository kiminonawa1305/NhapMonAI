...
public class EnvironmentState {
    ...
    public EnvironmentState(Environment.LocationState locAState,
                            ...
                            Environment.LocationState locCState,
                            Environment.LocationState locDState) {
    ...
    public Map<String, LocationState> getMapEnvironmentState() {
        return this.state;
    }

    public boolean isDone(){
        for(Map.Entry<String,LocationState> entry : this.state.entrySet()){
